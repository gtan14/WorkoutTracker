...
public class PyramidsetRestRowTextWatcher {
    ...
    //  public constructor that initializes text listeners and adds listener to edit texts
    public PyramidsetRestRowTextWatcher(DisplayWorkoutAdapter displayWorkoutAdapter, RestRowModel restRowModel, EditText minutes, EditText seconds){
